        ...
        <div v-if="step === 'email'">
          <div class="flex items-center gap-3 mb-4">
            <div class="w-10 h-10 rounded-xl bg-dabo/10 flex items-center justify-center">
              <svg class="w-5 h-5 text-dabo" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div v-else-if="step === 'code'">
          <div class="text-center mb-6">
            <div class="mx-auto mb-4 w-14 h-14 rounded-full bg-mint/20 flex items-center justify-center">
              <svg class="w-7 h-7 text-mint-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
